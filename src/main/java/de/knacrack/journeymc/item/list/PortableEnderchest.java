...
public class PortableEnderchest implements Item, Listener {

    @Override
    public ItemStack getItem() {
        return new ItemBuilder(Material.PAPER).setName("§dPortable Enderchest").addStringTag(getKey(), getLabel()).setCustomModelId(getCustomModelId()).getItem();
    }
    ...
    @EventHandler
    public void portableEnderchest(PlayerInteractEvent event) {
