...
public class OlafZombie extends CraftZombie {
    ...
    public OlafZombie(Location loc) {
        ...
        getEquipment().setItemInMainHand(new ItemStack(Material.IRON_AXE));
        getEquipment().setItemInOffHand(new ItemStack(Material.IRON_AXE));
